...
(function () {
  ...
  const TILES = [
    ...
    tile("05", "capital",
      ...
      { 6: { feature: "capital" }, 9: { resource: "oil" } },
      { 6: { feature: "capital" }, 7: { resource: "marble" } }),
    ...
    tile("06", "citystate",
      ...
      { 0: { resource: "mercury" }, 7: { cityState: "Kumasi" } }),
    ...
    tile("07", "citystate",
      ...
      { 1: { resource: "marble" }, 6: { cityState: "Brussels" } },
      { 0: { barbarian: "B" }, 3: { cityState: "Seoul" }, 9: { resource: "marble" } }),
    ...
    tile("09", "citystate",
      ...
      { 4: { resource: "mercury" }, 9: { cityState: "Geneva" } },
    ...
    tile("TI01", "citystate",
      ...
      { 5: { resource: "mercury" }, 7: { cityState: "Antananarivo" } },
    ...
    tile("TI03", "normal",
      ...
      { 1: { resource: "diamonds" }, 9: { resource: "marble" } },
      { 8: { resource: "marble" } }),
    // Printed tile 10
    tile("TI04", "normal",
  ...
  const CARD_DEFS = {
    ...
    military: {
      1: { name: "Masonry", effectText: "Reinforce up to this slot's number of your control tokens. Or attack a barbarian, city-state, rival city or rival control token in range. Your armies move up to 3 spaces. Your combat value equals this slot's number.", figures: "1 army", move: 3, armies: 1, combat: 0 },
      2: { name: "Iron Working", effectText: "Reinforce up to this slot's number of your control tokens. Or attack a barbarian, city-state, rival city or rival control token in range. Your armies move up to 4 spaces. Your combat value equals this slot's number plus 2.", figures: "2 armies", move: 4, armies: 2, combat: 0, vsBarbarian: 2 },
      3: { name: "Mass Production", effectText: "Reinforce up to this slot's number of your control tokens. Or attack a barbarian, city-state, rival city or rival control token in range. Your armies move up to 5 spaces, and across water. Your combat value equals this slot's number plus 2.", figures: "2 armies", move: 5, armies: 2, combat: 2, water: true },
      4: { name: "Flight", effectText: "Reinforce up to this slot's number of your control tokens. Or attack a barbarian, city-state, rival city or rival control token in range. Your armies move up to 6 spaces, and across water. Your combat value equals this slot's number plus 3.", figures: "2 armies", move: 6, armies: 2, combat: 3, water: true }
    },
    industry: {
